...
import { Send, X, Plus, Minus, Check, Eye, EyeOff, Smile } from "lucide-react";
            ...
            {options
              ...
              .map((opt, idx) => (
                ...
                >
                  <span>{opt}</span>
                  {correctIndex === idx && (
                    <div className="flex size-6 items-center justify-center rounded-full bg-brand-green">
                ...
                <div key={idx} className="flex items-center gap-2">
                  <button
                    ...
                    className={cn(
                      ...
                      correctIndex === idx
                        ? "border-brand-green bg-brand-green/30 text-white"
                        : "border-white/20 text-white/50 hover:border-white/40",
                    )}
                    title="Mark as correct answer"
                  >
                    {correctIndex === idx ? <Check className="size-4" /> : idx + 1}
                  </button>
                  <input
                    value={opt}
                    onChange={(e) => {
