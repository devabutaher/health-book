  ...
  "mb-2 flex shrink-0 items-center justify-center [&_svg]:pointer-events-none [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        gradient:
          "flex size-16 shrink-0 items-center justify-center rounded-full bg-gradient-to-br from-brand-teal/20 to-brand-green/20 text-brand-teal [&_svg:not([class*='size-'])]:size-8",
      },
    },
    defaultVariants: {
      variant: "default",
