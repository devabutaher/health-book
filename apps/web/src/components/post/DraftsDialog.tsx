...
export function DraftsDialog({ open, onClose }: { open: boolean; onClose: () => void }) {
    ...
    <>
      <Dialog open={open} onOpenChange={(o) => !o && onClose()}>
        <DialogContent className="sm:max-w-2xl max-h-[80vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle className="font-display text-lg">Your Drafts</DialogTitle>
            <DialogDescription>Continue where you left off.</DialogDescription>
          </DialogHeader>
