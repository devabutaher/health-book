...
export function playReactionSound() {
  try {
    ...
    osc.frequency.linearRampToValueAtTime(990, ctx.currentTime + 0.06);
...
export function playCommentSound() {
  try {
    ...
    osc.frequency.linearRampToValueAtTime(660, ctx.currentTime + 0.06);
...
export function playAdvanceSound() {
  try {
    ...
    osc.frequency.linearRampToValueAtTime(450, ctx.currentTime + 0.04);
...
export function playCheckSound() {
  try {
    ...
    osc.frequency.linearRampToValueAtTime(1320, ctx.currentTime + 0.04);
    gain.gain.setValueAtTime(0.06, ctx.currentTime);
    gain.gain.exponentialRampToValueAtTime(0.001, ctx.currentTime + 0.1);
    osc.start(ctx.currentTime);
    osc.stop(ctx.currentTime + 0.1);
...
export function playTabSound() {
  try {
    ...
    osc.frequency.linearRampToValueAtTime(500, ctx.currentTime + 0.03);
