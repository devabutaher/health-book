...
import { AlertCircle, ArrowLeft, Hash, SearchX } from "lucide-react";
...
export default function HashtagPage() {
  ...
  const { data, isLoading, isError, refetch } = useSearchPostsQuery(
    { q: `#${tag}` },
    { skip: !tag },
  );
    ...
    <div className="mx-auto max-w-[600px]">
      ...
      {isError ? (
        <Empty>
          ...
          <EmptyTitle>Couldn&apos;t load posts for #{tag}</EmptyTitle>
